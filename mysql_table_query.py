...
def workplace_info(project):
    db = pymysql.connect(host='1111111', user='root', password='2222222', database='building_information')
...
#     db = pymysql.connect(host='1111111', user='root', password='2222222', database='automation')
#     cursor1 = db.cursor(cursor=pymysql.cursors.DictCursor, )
