...
def workplace_info(project):
    db = pymysql.connect(host='123123123', user='root', password='11231231231', database='building_information')
...
def ip_planning(project):
    db = pymysql.connect(host='123123123123', user='root', password='123123123123', database='building_information')
...
def endpoint(project):
    db = pymysql.connect(host='123123123123', user='root', password='1231231231', database='building_information')
...
def equipment_type(project):
    db = pymysql.connect(host='123123123123', user='root', password='1231231231231', database='building_information')
...
def core_ip(project):
    db = pymysql.connect(host='12312312313', user='root', password='123123123123', database='building_information')
...
def dhcp(project):
    db = pymysql.connect(host='12312312312', user='root', password='12312312313', database='building_information')
...
#     db = pymysql.connect(host='1231231231', user='root', password='1231231231', database='building_information')
#     cursor1 = db.cursor(cursor=pymysql.cursors.DictCursor, )
