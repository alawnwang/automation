...
def workplace_info(project):
    db = pymysql.connect(host='12345678', user='root', password='87654321', database='building_information')
...
def ip_planning(project):
    ...
    cursor1 = db.cursor(cursor=pymysql.cursors.DictCursor, )
    ip_planning = "select * from ip_planning where project = '%s' ORDER BY vlan*1" %project
...
#     db = pymysql.connect(host='12345678', user='root', password='87654321', database='automation')
#     cursor1 = db.cursor(cursor=pymysql.cursors.DictCursor, )
