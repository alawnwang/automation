...
def get_ccs_fw_info(network,project):
    ...
    mgt_dict = {'floor': entry['floor'],'bdr':entry['bdr'],'up_phycial':ccs_fw_connect_ip[4],'down_phycial':ccs_connect_ip[3],'MCW': ('-'.join((generation_ccs_name(project), 'A01', str(get_ccs_fw_type(project)['name']), 'CCS', '01')))
