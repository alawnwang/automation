...
#     core_ip_dict = {'network':[core_ipaddress],'status':None,'domain':None,'vlan':None,'function':'核心网段','description':'interconnection','project':project,'building_name':None,'floor':None,'bdr':None,'type_of_workplace':None}
...
#         public_ip = {'network':[n['network']],'status':None,'domain':None,'vlan':[n['vlan']],'function':[n['fun']],'description':[n['desc']],'project':project,'building_name':None,'floor':[n['floor']],'bdr':[n['bdr']],'type_of_workplace':None}
...
#         oa_ip = {'network': [o['network']], 'status': None, 'domain': None, 'vlan': [o['vlan']], 'function': [o['fun']],
...
#         ty_ip = {'network': [t['network']], 'status': None, 'domain': None, 'vlan': [t['vlan']], 'function': [t['fun']],
...
#         voip_ip = {'network': [v['network']], 'status': None, 'domain': None, 'vlan': [v['vlan']], 'function': [v['fun']],
...
#
#     for i in ip_planning_list:
#         ip = pd.DataFrame.from_dict(i, orient='columns')
#         ip.to_sql(con=engine, name='ip_planning',if_exists='append', index=False)
#     session = Session()
#     session.commit()
#     session.close()
#     print('IP规划完成,请等待生成连接关系...')
#
def core_link():
#核心链接关系
    # print(coa_info.get_coa_info(project)['MCOA'],coa_info.get_coa_info(project)['port_assign']['interconnect'][0],coa_info.get_coa_info(project)['port_assign']['interconnect'][1])
