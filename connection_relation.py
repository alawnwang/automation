...
def connection_relation(network,project):
    connection_dict ={'mgtip':{'floor':[],'bdr':[],'device_name':[],'mgtip':[],'mgtmask':[]},'connect':{'floor':[],'bdr':[],'A_device':[],'A_port':[],'A_ip':[],'Z_device':[],'Z_port':[],'Z_ip':[]}}

#核心链接关系
    connection_dict['connect']['floor'].append(coa_info.get_coa_info(project)['floor'])
    connection_dict['connect']['bdr'].append(coa_info.get_coa_info(project)['bdr'])
