...
def connection_relation(network,project):
    ...
    connection_dict ={'mgtip':{'project':[],'floor':[],'bdr':[],'func':[],'device_name':[],'mgtip':[],'mgtmask':[],'gateway':[]},'connect':{'project':[],'A_floor':[],'A_bdr':[],'A_device':[],'A_port':[],'A_ip':[],'Z_floor':[],'Z_bdr':[],'Z_device':[],'Z_port':[],'Z_ip':[]}}
#
#核心链接关系
    connection_dict['mgtip']['project'].append(project)
    connection_dict['mgtip']['floor'].append(str(coa_info_summary['floor']))
    connection_dict['mgtip']['bdr'].append(coa_info_summary['bdr'])
    connection_dict['mgtip']['func'].append('COA')
    connection_dict['mgtip']['device_name'].append(coa_info_summary['MCOA'])
    connection_dict['mgtip']['mgtip'].append(coa_info_summary['MMGTIP']['ip'])
    connection_dict['mgtip']['mgtmask'].append(coa_info_summary['MMGTIP']['netmask'])
    connection_dict['mgtip']['gateway'].append(None)
    connection_dict['mgtip']['project'].append(project)
    connection_dict['mgtip']['floor'].append(str(coa_info_summary['floor']))
    connection_dict['mgtip']['bdr'].append(coa_info_summary['bdr'])
    connection_dict['mgtip']['func'].append('COA')
    connection_dict['mgtip']['device_name'].append(coa_info_summary['SCOA'])
    connection_dict['mgtip']['mgtip'].append(coa_info_summary['SMGTIP']['ip'])
    connection_dict['mgtip']['mgtmask'].append(coa_info_summary['SMGTIP']['netmask'])
    connection_dict['mgtip']['gateway'].append(None)
...
#接入到汇聚互联/管理IP
    for doa in doa_info_summary:
        ...
        connection_dict['mgtip']['func'].append('DOA')
        ...
        for xoa in access_info_summary:
            if str(doa['DDOA']['floor'])+str(doa['DDOA']['bdr']) == str(xoa['floor'])+str(xoa['bdr']):
                for dx in xoa['DXOA']:
                    ...
                    connection_dict['mgtip']['func'].append('XOA')
                ...
                for ve in xoa['VEVP']:
                    ...
                    connection_dict['mgtip']['func'].append('EVP')
                ...
                for ew in xoa['VEWL']:
                    ...
                    connection_dict['mgtip']['func'].append('EWL')
