...
def connection_relation(network,project):
    ...
    xl_info_summary = xl_info.get_xl_info(project)
...
#核心链接关系
    ...
    connection_dict['connect']['A_bdr'].append(cwl_info_summary['bdr'])
    connection_dict['connect']['A_device'].append(cwl_info_summary['MCW'])
    connection_dict['connect']['A_port'].append('Bridge-Aggregation1')
    connection_dict['connect']['A_ip'].append('Trunk')
    connection_dict['connect']['Z_floor'].append(str(cwl_info_summary['floor']))
    connection_dict['connect']['Z_bdr'].append(cwl_info_summary['bdr'])
    connection_dict['connect']['Z_device'].append(cwl_info_summary['SCW'])
    connection_dict['connect']['Z_port'].append('Bridge-Aggregation1')
    connection_dict['connect']['Z_ip'].append('Trunk')
    # 大厦核心-无线核心-1
    connection_dict['connect']['project'].append(project)
    connection_dict['connect']['A_floor'].append(str(coa_info_summary['floor']))
    ...
    connection_dict['connect']['A_device'].append(coa_info_summary['SCOA'])
    connection_dict['connect']['A_port'].append(coa_info_summary['port_assign']['ccs'])
    connection_dict['connect']['A_ip'].append(str('vlan 550'+'/'+coa_info_summary['SMGTIP']['ccsip']) + ' / ' + str(
    ...
    connection_dict['connect']['Z_ip'].append('vlan550'+ ccs_info_summary['MMGTIP']['uplink']+' / ' +ccs_info_summary['MMGTIP']['vlan_gateway'])
    # 防火墙-控制网核心-2
    connection_dict['connect']['project'].append(project)
    connection_dict['connect']['A_floor'].append(str(ccs_fw_summary['floor']))
    connection_dict['connect']['A_bdr'].append(ccs_fw_summary['bdr'])
    ...
    connection_dict['connect']['Z_port'].append(ccs_info_summary['port_assign']['uplink'])
    connection_dict['connect']['Z_ip'].append('vlan550'+ ccs_info_summary['SMGTIP']['uplink']+' / ' +ccs_info_summary['SMGTIP']['vlan_gateway'])
    # 控制网核心互联-1
    connection_dict['connect']['project'].append(project)
    connection_dict['connect']['A_floor'].append(str(ccs_info_summary['floor']))
    connection_dict['connect']['A_bdr'].append(ccs_info_summary['bdr'])
    connection_dict['connect']['A_device'].append(ccs_info_summary['MCCS'])
    connection_dict['connect']['A_port'].append(ccs_info_summary['port_assign']['interconnect'][0])
    connection_dict['connect']['A_ip'].append('Trunk')
    connection_dict['connect']['Z_floor'].append(str(ccs_info_summary['floor']))
    connection_dict['connect']['Z_bdr'].append(ccs_info_summary['bdr'])
    connection_dict['connect']['Z_device'].append(ccs_info_summary['SCCS'])
    connection_dict['connect']['Z_port'].append(ccs_info_summary['port_assign']['interconnect'][0])
    connection_dict['connect']['Z_ip'].append('Trunk')
    # 控制网核心互联-2
    connection_dict['connect']['project'].append(project)
    connection_dict['connect']['A_floor'].append(str(ccs_info_summary['floor']))
    connection_dict['connect']['A_bdr'].append(ccs_info_summary['bdr'])
    connection_dict['connect']['A_device'].append(ccs_info_summary['MCCS'])
    connection_dict['connect']['A_port'].append(ccs_info_summary['port_assign']['interconnect'][1])
    connection_dict['connect']['A_ip'].append('Trunk')
    connection_dict['connect']['Z_floor'].append(str(ccs_info_summary['floor']))
    connection_dict['connect']['Z_bdr'].append(ccs_info_summary['bdr'])
    connection_dict['connect']['Z_device'].append(ccs_info_summary['SCCS'])
    connection_dict['connect']['Z_port'].append(ccs_info_summary['port_assign']['interconnect'][1])
    connection_dict['connect']['Z_ip'].append('Trunk')
    # 控制网核心互联-聚合口
    connection_dict['connect']['project'].append(project)
    connection_dict['connect']['A_floor'].append(str(ccs_info_summary['floor']))
...
# 接入到汇聚互联/管理IP
    ...
    ccs_downlink_port = ccs_info_summary['port_assign']['downlink']
    for xl in xl_info_summary:
        if len(xl['xl']) > 1:

            for i in xl['xl']:
                xl_link_port = ccs_downlink_port.__next__()
                connection_dict['mgtip']['project'].append(project)
                connection_dict['mgtip']['floor'].append(i['floor'])
                connection_dict['mgtip']['bdr'].append(i['bdr'])
                connection_dict['mgtip']['device_name'].append(i['name'])
                connection_dict['mgtip']['mgtip'].append(str(i['ip']))
                connection_dict['mgtip']['mgtmask'].append(i['netmask'])
                connection_dict['mgtip']['gateway'].append(i['gateway'])

                connection_dict['connect']['project'].append(project)
                connection_dict['connect']['A_floor'].append(str(ccs_info_summary['floor']))
                connection_dict['connect']['A_bdr'].append(ccs_info_summary['bdr'])
                connection_dict['connect']['A_device'].append(ccs_info_summary['MCCS'])
                connection_dict['connect']['A_port'].append(xl_link_port)
                connection_dict['connect']['A_ip'].append('Trunk')
                connection_dict['connect']['Z_floor'].append(str(i['floor']))
                connection_dict['connect']['Z_bdr'].append(i['bdr'])
                connection_dict['connect']['Z_device'].append(i['name'])
                connection_dict['connect']['Z_port'].append(i['port_assign'][0])
                connection_dict['connect']['Z_ip'].append('Trunk')

                connection_dict['connect']['project'].append(project)
                connection_dict['connect']['A_floor'].append(str(ccs_info_summary['floor']))
                connection_dict['connect']['A_bdr'].append(ccs_info_summary['bdr'])
                connection_dict['connect']['A_device'].append(ccs_info_summary['SCCS'])
                connection_dict['connect']['A_port'].append(xl_link_port)
                connection_dict['connect']['A_ip'].append('Trunk')
                connection_dict['connect']['Z_floor'].append(str(i['floor']))
                connection_dict['connect']['Z_bdr'].append(i['bdr'])
                connection_dict['connect']['Z_device'].append(i['name'])
                connection_dict['connect']['Z_port'].append(i['port_assign'][1])
                connection_dict['connect']['Z_ip'].append('Trunk')

        else:
            xl_link_port = ccs_downlink_port.__next__()
            connection_dict['mgtip']['project'].append(project)
            connection_dict['mgtip']['floor'].append(xl['floor'])
            connection_dict['mgtip']['bdr'].append(xl['bdr'])
            connection_dict['mgtip']['device_name'].append(xl['xl'][0]['name'])
            connection_dict['mgtip']['mgtip'].append(str(xl['xl'][0]['ip']))
            connection_dict['mgtip']['mgtmask'].append(xl['xl'][0]['netmask'])
            connection_dict['mgtip']['gateway'].append(xl['xl'][0]['gateway'])
            ...
            connection_dict['connect']['A_port'].append(xl_link_port)
            connection_dict['connect']['A_ip'].append('Trunk')
            connection_dict['connect']['Z_floor'].append(xl['floor'])
            connection_dict['connect']['Z_bdr'].append(xl['bdr'])
            connection_dict['connect']['Z_device'].append(xl['xl'][0]['name'])
            connection_dict['connect']['Z_port'].append(xl['xl'][0]['port_assign'][0])
            connection_dict['connect']['Z_ip'].append('Trunk')
            #
            connection_dict['connect']['project'].append(project)
            connection_dict['connect']['A_floor'].append(str(ccs_info_summary['floor']))
